...
const VirtualTryOn = () => {
  ...
  const handleVirtualTryOn = async () => {
    ...
    const WEBHOOK_URL = 'https://ryann8n.zeabur.app/webhook/4152e7a6-f63a-4091-9b6a-b367db43fcc9';
            ...
            >
              {isProcessing ? (
                <div className="flex flex-col items-center py-2 gap-1">
                  ...
                  <span className="text-sm font-normal">(Estimated time: 2 mins)</span>
                </div>
              ) : (
          ...
          <div className="relative">
            ...
            <div className="relative bg-gradient-to-br from-white/3 to-white/1 backdrop-blur-xl rounded-3xl p-12 border border-white/5 shadow-[0_25px_80px_-20px_rgba(0,0,0,0.4)]">
              <div className="text-center mb-16">
                <div className="inline-block relative mb-8">
                  <h3 className="font-playfair text-4xl md:text-5xl font-bold text-white mb-6 relative z-10">
                    {t('virtualTryOn.cases')}
                  </h3>
                  <div className="absolute -inset-4 bg-gradient-to-r from-[hsl(45,60%,50%,0.1)] to-[hsl(45,80%,60%,0.1)] blur-xl rounded-full"></div>
                </div>
                <p className="text-xl text-white/60 max-w-2xl mx-auto mb-6">
                  {t('virtualTryOn.caseDescription')}
                </p>
                <div className="flex items-center justify-center gap-3">
                  <div className="h-px w-12 bg-gradient-to-r from-transparent to-[hsl(45,60%,50%)]"></div>
                  <div className="w-2 h-2 bg-[hsl(45,60%,50%)] rounded-full"></div>
              ...
              <div className="text-center mb-8">
                <div className="inline-flex items-center gap-3 bg-gradient-to-r from-white/5 to-white/10 backdrop-blur-xl rounded-full px-6 py-3 border border-white/10">
                  <div className="w-2 h-2 bg-gradient-to-r from-[hsl(45,60%,50%)] to-[hsl(45,80%,60%)] rounded-full"></div>
                  <h3 className="font-playfair text-2xl font-bold text-white">{t('case.case1')}</h3>
                </div>
              </div>

              {/* Case 1 */}
              <div className="grid grid-cols-1 md:grid-cols-3 gap-0 max-w-6xl mx-auto mb-16">
                <div className="group text-center">
                  <div className="relative overflow-hidden rounded-2xl mb-6 transform transition-all duration-700 hover:scale-105 hover:-rotate-1">
                    <div className="aspect-[2/3] bg-gradient-to-br from-white/8 to-white/3 backdrop-blur-sm border border-white/10 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3)] overflow-hidden">
                      ...
                      <div className="absolute bottom-6 left-6 bg-gradient-to-r from-[hsl(45,60%,50%)] to-[hsl(45,80%,60%)] backdrop-blur-md rounded-full px-4 py-2 text-black text-sm font-bold">
                        {t('case.originalPhoto')}
                      </div>
                    </div>
                  </div>
                ...
                <div className="group text-center">
                  <div className="relative overflow-hidden rounded-2xl mb-6 transform transition-all duration-700 hover:scale-105 hover:-rotate-1">
                    <div className="aspect-[2/3] bg-gradient-to-br from-white/8 to-white/3 backdrop-blur-sm border border-white/10 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3)] overflow-hidden">
                      ...
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent"></div>
                      <div className="absolute bottom-6 left-6 bg-gradient-to-r from-[hsl(210,15%,40%)] to-[hsl(210,20%,30%)] backdrop-blur-md rounded-full px-4 py-2 text-white text-sm font-bold">
                        {t('case.selectedClothing')}
                      </div>
                    </div>
                  </div>
                ...
                <div className="group text-center">
                  <div className="relative overflow-hidden rounded-2xl mb-6 transform transition-all duration-700 hover:scale-105 hover:rotate-1">
                    <div className="aspect-[2/3] bg-gradient-to-br from-white/8 to-white/3 backdrop-blur-sm border border-[hsl(45,60%,50%,0.3)] shadow-[0_20px_60px_-15px_rgba(197,149,96,0.4)] overflow-hidden">
                      ...
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent"></div>
                      <div className="absolute bottom-6 left-6 bg-gradient-to-r from-[hsl(45,60%,50%)] to-[hsl(45,80%,60%)] backdrop-blur-md rounded-full px-4 py-2 text-black text-sm font-bold shadow-lg">
                        {t('tryOn.perfectDisplay')}
                      </div>
                    </div>
                  </div>
                  <h4 className="font-playfair text-xl font-bold text-white mb-2">{t('case.exclusiveResult')}</h4>
                  <p className="text-white/50">{t('case.perfectTryOnEffect')}</p>
                </div>
              </div>
              ...
              <div className="text-center mb-8">
                <div className="inline-flex items-center gap-3 bg-gradient-to-r from-white/5 to-white/10 backdrop-blur-xl rounded-full px-6 py-3 border border-white/10">
                  <div className="w-2 h-2 bg-gradient-to-r from-[hsl(200,60%,50%)] to-[hsl(200,80%,60%)] rounded-full"></div>
                  <h3 className="font-playfair text-2xl font-bold text-white">{t('case.case2')}</h3>
                </div>
              </div>

              {/* Case 2 - 4 with similar luxury treatment */}
              <div className="grid grid-cols-1 md:grid-cols-3 gap-0 max-w-6xl mx-auto mb-16">
                <div className="group text-center">
                  <div className="relative overflow-hidden rounded-2xl mb-6 transform transition-all duration-700 hover:scale-105 hover:-rotate-1">
                    <div className="aspect-[2/3] bg-gradient-to-br from-white/8 to-white/3 backdrop-blur-sm border border-white/10 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3)] overflow-hidden">
              ...
              <div className="text-center mb-8">
                <div className="inline-flex items-center gap-3 bg-gradient-to-r from-white/5 to-white/10 backdrop-blur-xl rounded-full px-6 py-3 border border-white/10">
                  <div className="w-2 h-2 bg-gradient-to-r from-[hsl(280,60%,50%)] to-[hsl(280,80%,60%)] rounded-full"></div>
                  <h3 className="font-playfair text-2xl font-bold text-white">{t('case.case3')}</h3>
                </div>
              </div>
              ...
              <div className="text-center mb-8">
                <div className="inline-flex items-center gap-3 bg-gradient-to-r from-white/5 to-white/10 backdrop-blur-xl rounded-full px-6 py-3 border border-white/10">
                  <div className="w-2 h-2 bg-gradient-to-r from-[hsl(320,60%,50%)] to-[hsl(320,80%,60%)] rounded-full"></div>
                  <h3 className="font-playfair text-2xl font-bold text-white">案例四</h3>
                </div>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-3 gap-0 max-w-6xl mx-auto mb-12">
                <div className="group text-center">
                  <div className="relative overflow-hidden rounded-2xl mb-6 transform transition-all duration-700 hover:scale-105 hover:-rotate-1">
                    <div className="aspect-[2/3] bg-gradient-to-br from-white/8 to-white/3 backdrop-blur-sm border border-white/10 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3)] overflow-hidden">
                      <img
                ...
                <div className="group text-center">
                  <div className="relative overflow-hidden rounded-2xl mb-6 transform transition-all duration-700 hover:scale-105 hover:-rotate-1">
                    <div className="aspect-[2/3] bg-gradient-to-br from-white/8 to-white/3 backdrop-blur-sm border border-white/10 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3)] overflow-hidden">
                      ...
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent"></div>
                      <div className="absolute bottom-6 left-6 bg-gradient-to-r from-[hsl(45,40%,40%)] to-[hsl(45,50%,35%)] backdrop-blur-md rounded-full px-4 py-2 text-white text-sm font-bold">
                        {t('case.luxuryAccessory')}
                      </div>
                    </div>
                  </div>
